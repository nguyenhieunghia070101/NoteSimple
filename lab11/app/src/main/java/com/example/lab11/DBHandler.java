...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String DATE_COL = "ngay";
    ...
    public void addNewCourse(String courseName, String courseDescription, String selectedDate) {
        //String selectedDate
        ...
        values.put(DATE_COL, selectedDate);
    ...
    public void deleteCourse(String courseName) {
        ...
        db.delete(TABLE_NAME, "id=?", new String[]{stid});
        db.close();*/
    }
